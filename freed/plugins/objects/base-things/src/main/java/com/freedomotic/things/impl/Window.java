...
public class Window  extends ElectricDevice{
	
	private RangedIntBehaviorLogic opening ;
	private int openingStoredValue=0 ;
	protected final static String BEHAVIOR_CURTAIN_STATE="windowState" ;
	  ...
	  @Override
	    ...
	    public void executeBrightness(int rangeValue, Config params) {
	        boolean executed = executeCommand("set windowState", params); //executes the developer level command associated with 'set brightness' action
	    ...
	    protected void createCommands() {
	        ...
	        b.setName("Increase " + getPojo().getName() + " window state");
	        ...
	        d.setName("Set its opening to 50%");
	        // d.setDescription(I18n.msg("set_its_brightness_to_50"));
	        d.setDescription("Set its opening to 50%");
	        ...
	        e.setName("Increase its opening");
	        ...
	        f.setDescription("decreases its opening of one step");
	        ...
	        g.setName("Set its opening to the value in the event");
	        g.setDescription("set its opening to the value in the event");

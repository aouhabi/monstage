...
public class JenaEngine {
	 ...
	 */
	static public Map<String, String> executeQuery(Model model, String queryString) {
		...
		try {
			...
			while (results.hasNext()) {
				...
				Literal inte = soln.getLiteral("int");
				resultQuery = resultQuery+inte.getLexicalForm()+"\t"+id.getLexicalForm()+";";
				resultMap.put(id.getLexicalForm(), inte.getLexicalForm());
	...
	static public Map<String, String> executeQueryConflit(Model model, String queryString) {
		Query query = QueryFactory.create(queryString);
		// No reasoning
		// Execute the query and obtain results
		QueryExecution qe = QueryExecutionFactory.create(query, model);
		...
		try {
			...
			while (results.hasNext()) {
				...
				Literal id = soln.getLiteral("id");
				Resource concept = soln.getResource("concept");
				resultQuery = resultQuery+id.getLexicalForm()+"\t"+concept.getLocalName()+";";
				resultMap.put(concept.getLocalName(), id.getLexicalForm());
				*/
				
				Resource concept = soln.getResource("concept");
				Literal id = soln.getLiteral("name");
				Literal inte = soln.getLiteral("name1");
				resultQuery = resultQuery+inte.getLexicalForm()+"\t"+id.getLexicalForm()+";";
	 ...
	 * + Sortie: le resultat de la requete en String
	 */
	static public Map<String, String> executeQueryFile(Model model, String filepath) {
	 ...
	 * + Sortie: le resultat de la requete en String
	 */
	static public Map<String, String> executeQueryFileWithParameter(Model model, String
